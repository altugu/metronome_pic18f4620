...
# 750 "/opt/microchip/xc8/v2.30/pic/include/pic18_chip_select.inc" 3
# 1 "/opt/microchip/xc8/v2.30/pic/include/proc/pic18f4620.inc" 1 3
# 48 "/opt/microchip/xc8/v2.30/pic/include/proc/pic18f4620.inc" 3
PORTA equ 0F80h
...
TOSU equ 0FFFh
# 4576 "/opt/microchip/xc8/v2.30/pic/include/proc/pic18f4620.inc" 3
...
# 751 "/opt/microchip/xc8/v2.30/pic/include/pic18_chip_select.inc" 2 3
...
CONFIG MCLRE = ON ; ((PORTE) and 0FFh), 3, a Pin Enable bit (((PORTE) and 0FFh), 3, a pin enabled; ((PORTE) and 0FFh), 3, a input pin disabled)
; CONFIG4L
...
event_loop: ;
 ...
 bsf LATA, 0 ; ((PORTA) and 0FFh), 0, a <- 1
 call load_speed
